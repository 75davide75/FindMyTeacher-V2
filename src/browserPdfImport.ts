...
import { dayOrder, type DayId, type Lesson, type Period, type ScheduleData } from './types'
...
export async function parseSchedulePdfInBrowser(file: File): Promise<ScheduleData> {
  if (!workerReady) {
